...
module.exports = {
    ...
    OPEN_STATUSES: ['Initiated', 'Open', 'In-Process', 'In Progress', 'New Issue','Ready to Schedule','Service in progress','Waiting for Engineering','Scheduled','Service In Progress','Field Review'],
